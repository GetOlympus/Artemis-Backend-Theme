...
class ArtemisOptionsAdminPage extends \GetOlympus\Zeus\AdminPage\Controller\AdminPage
{
    public function setVars()
    {
        ...
        $this->getModel()->setPages([
            'artemis-options' => [
                // Page options
                'parent'    => 'themes.php',
                'title'     => __('Artemis', OL_ARTEMIS_DICTIONARY),
                'name'      => __('Artemis options', OL_ARTEMIS_DICTIONARY),
                'sections'  => [
                    'login'     => [
    ...
    public function setFilters()
    {
        ...
        add_filter('ol_zeus_adminpage_artemis-options-login_contents', function ($contents) use ($path, $site, $name) {
            return [
                ...
                \GetOlympus\Field\Radio::build('ol_artemis_login_error_message', [
                    'title'         => __('Use Artemis custom error message?', OL_ARTEMIS_DICTIONARY),
                    'description'   => __('You can find all custom error messages in the <a href="'.WP_PLUGIN_URL.S.$path.S.'languages'.S.'languages.json" target="_blank"><code>plugin languages folder</code></a>.', OL_ARTEMIS_DICTIONARY),
                    'default'       => 1,
                    'options'       => [
                ...
                \GetOlympus\Field\Radio::build('ol_artemis_login_style', [
                    ...
                    'description'   => __('By setting this option to <code>Yes</code>, WordPress will only use the default Artemis Backend Theme CSS stylesheet.<br/>The file can be found here: <a href="'.WP_PLUGIN_URL.S.$path.S.'resources'.S.'assets'.S.'css'.S.'artemis.login.min.css" target="_blank"><code>'.$path.S.'resources'.S.'assets'.S.'css'.S.'artemis.login.min.css</code></a>', OL_ARTEMIS_DICTIONARY),
                    'default'       => 0,
                    'options'       => [
                        0 => __('No', OL_ARTEMIS_DICTIONARY),
                        1 => __('Yes', OL_ARTEMIS_DICTIONARY),
        ...
        // olh_adminpage_MAINPAGE-SUBPAGE-SUBSECTION_contents
        add_filter('ol_zeus_adminpage_artemis-options-custom_contents', function ($contents) {
            return [
