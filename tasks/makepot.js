...
module.exports = function (grunt, configs) {
  var files = grunt.file.expand({filter: "isFile"}, configs.phpfiles),
    srcpath = configs.paths.src + '/' + configs.paths.i18n,
  ...
  return {
    app: {
      options: {
        ...
        include: files,
        mainFile: files[0],
        potComments: '@package olympus-artemis-backend-theme\n@subpackage pot-languages\n@author Achraf Chouk <achrafchouk@gmail.com>\n@since 0.0.1\n{year}',
        potFilename: configs.textdomain + '.pot',
        type: 'wp-plugin'
      }
    }
  }
